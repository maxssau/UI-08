#ifndef __LCD_SSD1306___
#define __LCD_SSD1306___ 1
void I2C_Init(void);
void I2C_Start(void);
void I2C_Stop(void);
...
void I2C_Init(void)
{
  ...
  GPIO_InitStruct_sda.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct_sda.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct_scl.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct_scl.Pull = GPIO_NOPULL;
