...
#define USB_AUDIO_CONFIG_PLAY_RES_BIT                24//16//24 /* 24 bit per sample */
...
#define USB_AUDIO_CONFIG_PLAY_USE_FREQ_88_K           1 /* to set by user:  1 : to use , 0 to not support*/
...
//#define USB_AUDIO_CONFIG_PLAY_SAI_COUNT               (USB_AUDIO_CONFIG_PLAY_CHANNEL_COUNT / 2)
